...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> CASTLE_FLOOR_FAKE = registerWithItemSP("castle_floor_fake", BlockIndestructibleFake::new);
    ...
    public static final RegistryObject<Block> COVERED_WALL = registerWithItemSP("covered_floor", BlockCovered::new);
