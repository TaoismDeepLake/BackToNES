...
//    public static final RegistryObject<Block> BOX_10 = registerWithItem("box_10", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
//    public static final RegistryObject<Block> BOX_11 = registerWithItem("box_11", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
//    public static final RegistryObject<Block> BOX_12 = registerWithItem("box_12", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
//    public static final RegistryObject<Block> BOX_13 = registerWithItem("box_13", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
//    public static final RegistryObject<Block> BOX_14 = registerWithItem("box_14", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
//    public static final RegistryObject<Block> BOX_15 = registerWithItem("box_15", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
//    public static final RegistryObject<Block> BOX_16 = registerWithItem("box_16", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
//    public static final RegistryObject<Block> BOX_17 = registerWithItem("box_17", () ->new BlockAchvBox(ItemRegistry.MONGO_SWORD, AdvancementUtil.ACHV_MANTLE));
